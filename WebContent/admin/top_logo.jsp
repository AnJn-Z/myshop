...
<html>
	...
	<head>
		...
		<style type="text/css">
			body{width:100%;height:64px; box-shadow: 0px 2px 6px 0px rgba(0, 0, 0, 0.2);border: 1px solid white;background:white;}
			.top_logo_box{overflow:hidden;}
			.timeanduser{line-height: 64px; }
			#get_thisname{float:left; line-height: 65px;color:#636778;}
			.timeanduser{float:right;background:url(../img/user_header.svg) no-repeat; background-size: 25px 25px;background-position: 5px center;padding-left: 35px;}
