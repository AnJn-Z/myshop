...
<html>
	...
	<body>
		...
		<p id="carbuy" class="innerclass"><a href="index">继续购物</a> <span style="padding-left: 20px;color: #ff6700;font-size:18px;">合计 <b id="sum">3999</b>元 </span> <span id="btnorder">去结算</span></p>
